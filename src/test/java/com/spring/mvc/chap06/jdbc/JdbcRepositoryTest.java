...
class JdbcRepositoryTest {
    ...
    @Test
    @DisplayName("회원번호가 1인 회원을 삭제해야한다")
    void deleteTest() {
        // given
        String id = "1";
    ...
    @Test
    @DisplayName("랜덤회원아이디를 가진 회원을 10명 등록해야한다.")
    void bulkInsertTest() {
    ...
    @Test
    @DisplayName("전체회원아이디를 가진 회원을 조회")
    void findAll() {
    ...
    @Test
    @DisplayName("특정아이디 회원을 조회하면 하나의 회원만조회된다.")
    void findOne() {

        String id = "0.29375825336192396";
